...
@WebServlet(name = "SearchStudent2", urlPatterns={"/searchStudent2"})

public class SearchStudent2 extends HttpServlet
{
	InputStream f = null;
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException 
	{
		...
		try
		{
			...
			out.println("<img src='abc112.jpg' width='250' height='260'>");
		}
		catch(Exception e)
		{
			out.println(e);
		...
		out.println("<form action='searchStudent2' method='post'>");
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)throws ServletException,IOException
	{
		...
		try
		{
            ...
            if (resultSet.next()) 
			{
				...
				out.println("<form action='searchStudent2' method='get'>");
			    out.println("<input type='submit' value='Back To Search'><br><br>");
				out.println("</form>");
